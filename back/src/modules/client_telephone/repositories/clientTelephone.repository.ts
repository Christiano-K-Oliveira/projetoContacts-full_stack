...
export abstract class ClientTelephoneRepository {
  abstract create(
    data: CreateClientTelephoneDto,
    clientId: string,
  ): Promise<ClientTelephone> | ClientTelephone;
  abstract findOne(
    client_id: string,
  ): Promise<ClientTelephone[] | undefined> | ClientTelephone[] | undefined;
  abstract update(
    id: string,
    data: UpdateClientTelephoneDto,
  ): Promise<ClientTelephone> | ClientTelephone;
  abstract delete(id: string): Promise<void> | void;
  abstract findByClientTelephone(
    id: string,
    number: string,
  ): Promise<ClientTelephone | undefined> | ClientTelephone | undefined;
}
